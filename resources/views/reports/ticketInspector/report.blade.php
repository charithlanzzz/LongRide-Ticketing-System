...
<head>
    ...
    <title>Ticket Inspectors Report</title>
    <style>
        * {
            font-size: 21px;
        ...
        <header style=" border: 1px solid white">
            <table style="width:100%; margin-top: 0%;">
                <tr style="width:100%" >
                    ...
                    <td style="width:70%"  align="right"  valign="bottom"><h1><span style="font-style:italic; color:#b6b4b4; font-size:16px">Ticket Inspector Report : {{date('Y-m-d')}}</span></h1></td>
                </tr>
            </table>
            <hr />
            ...
            <table width="100%" id="appointment_table">
                ...
                <tbody>
                    @foreach ($data['result'] as $res)
                        <tr>
                            <td scope="col">{{$res->firstname}}</td>
                            <td scope="col" >{{$res->lastname}}</td>
                            <td scope="col">{{$res->city}}</td>
