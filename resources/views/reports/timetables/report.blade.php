...
<head>
    ...
    <body>
        ...
        <div class="center content" style="margin-top:2%;  border: 1px solid white">
                    ...
                    <div class="div1">
                        <table class="table table-striped mg-b-0 text-md-nowrap" id="zero_config">
                            <thead>
                                <tr>
                                    <th scope="col">Day</th>
                                    <td  style="text-align: center; color: green">Monday</td>
                                </tr>
                                <tr>
                    ...
                    <div class="div1">
                        <table class="table table-striped mg-b-0 text-md-nowrap" id="zero_config">
                            <thead>
                                <tr>
                                    <th scope="col">Day</th>
                                    <td  style="text-align: center; color: red">Wednesday</td>
                                </tr>
                                <tr>
                                    <th scope="col">Departure Time</th>
                                    <th scope="col">Arrival Time</th>
                    ...
                    <div class="div2">
                        <table class="table table-striped mg-b-0 text-md-nowrap" id="zero_config">
                            <thead>
                                <tr>
                                    <th scope="col">Day</th>
                                    <td  style="text-align: center; color: orange">Thursday</td>
                                </tr>
                                <tr>
                                    <th scope="col">Departure Time</th>
                                    <th scope="col">Arrival Time</th>
                        ...
                        <div class="div1">
                            <table class="table table-striped mg-b-0 text-md-nowrap" id="zero_config">
                                <thead>
                                    <tr>
                                        <th scope="col">Day</th>
                                        <td  style="text-align: center; color: salmon">Friday</td>
                                    </tr>
                                    <tr>
                                        <th scope="col">Departure Time</th>
                                        <th scope="col">Arrival Time</th>
                        ...
                        <div class="div2">
                            <table class="table table-striped mg-b-0 text-md-nowrap" id="zero_config">
                                <thead>
                                    <tr>
                                        <th scope="col">Day</th>
                                        <td  style="text-align: center; color: indigo">Saturday</td>
                                    </tr>
                                    <tr>
                                        <th scope="col">Departure Time</th>
                                        <th scope="col">Arrival Time</th>
                            ...
                            <div class="div1">
                                <table class="table table-striped mg-b-0 text-md-nowrap" id="zero_config">
                                    <thead>
                                        <tr>
                                            <th scope="col">Day</th>
                                            <td  style="text-align: center; color: blue">Sunday</td>
                                        </tr>
                                        <tr>
                                            <th scope="col">Departure Time</th>
                                            <th scope="col">Arrival Time</th>
