        ...
        <header style=" border: 1px solid white">
            ...
            <table style="width:100%"><!-- 3 -->
                <tr style="width:600px">
                    <td style="background-color:#A6A6A6;width:100%; color:#FFF; padding-left:15px; padding-bottom:7px; padding-top:7px; font-weight:bold">@if($data['from'] != '' && $data['to'] !='') All Passengers &nbsp; From {{ ' : '.$data['from']}} &nbsp; To {{ ' : '.$data['to']}} @else All Passengers @endif</td>
                </tr>
            </table>
        </header>
            ...
            <table width="100%" id="appointment_table">
                ...
                <tbody>
                    @foreach ($data['result'] as $res)
                        <tr>
                            <td scope="col">{{$res->passenger_id}}</td>
                            <td scope="col">{{$res->first_name}}</td>
                            <td scope="col" >{{$res->last_name}}</td>
