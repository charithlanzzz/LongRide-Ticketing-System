...
@section('sub_title','Add Time Table')
...
<div class="row">
    <div class="col-md-12">
        <div class="card custom-card h-100">
                    <form action="{{route('create_timetable')}}" method="POST" class="login-form" id="create_timeTable_form">
                        @csrf
                    <div class="card-body">
                        <h6 class="card-title mb-3">Add Time Table</h6>
                        <div class="row justify-content-center">
                            <div class="col-md-4">
                                <div class="form-group @error('day') has-danger @enderror">
                                    <input class="form-control" placeholder="routeId" type="routeId" name="routeId" value="{{$routeId}}" hidden>
                                    <label>Day</label>
                                ...
                                <div class="form-group @error('arrivaltime') has-danger @enderror">
                                    ...
                                    <input class="timepicker form-control" placeholder="00:00" type="text" name="arrivaltime"  @if(!empty(old('arrivaltime'))) value="{{old('arrivaltime')}}" @else value="" @endif>
                                    @error('arrivaltime')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group @error('vehicleId') has-danger @enderror">
                                    ...
                                    <select class="form-control select2" name="vehicleId" id="vehicleId">
                                        <option value=" " label="Select the Vehicle">
                                           Select the Vehicle
                                        </option>
                                        @foreach($vehicles as $vehicle)
										<div class="col-lg-3">
                                            <option value="{{$vehicle[0]->vehicleId}}" label="{{$vehicle[0]->vehicleNumber}}">
                                ...
                                <div class="form-group @error('depaturetime') has-danger @enderror">
                                    ...
                                    <input class="timepicker form-control" placeholder="00:00" type="text" name="depaturetime" @if(!empty(old('depaturetime'))) value="{{old('depaturetime')}}" @else value="" @endif>
                                    @error('depaturetime')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
